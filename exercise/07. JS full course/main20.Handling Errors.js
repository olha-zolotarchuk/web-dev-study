...
// Of course, the other error types, like a syntax error, a reference error, a type error, those are also constructors.

//real time , runtime

function increment(a) {
  if (a == 7) {
    throw new Error("Can't increament 7");
  }
  return a + 1;
}

function incDevide(a, b) {
  if (b == 0) {
...
function rating(value) {
    ...
    throw new Error("Out of range val < 10");
  }
  return value;
}
